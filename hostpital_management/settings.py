...
SECRET_KEY = "django-insecure-0+h$_r4eqdihzguro#$3r3t_ep*@(yj1mk8z%@u^iqrx=b&8q2"
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'rest_framework.authentication.SessionAuthentication' # for browsable api user login check
    ),
